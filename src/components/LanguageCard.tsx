...
/**
 * The same control on the sign-in and sign-up screens, without the card.
 *
 * This is where it matters most and where it was missing: someone opening an
 * invite link for the first time has no account yet, so the copy of this on Me
 * is behind a door they can't get through. The action writes the cookie
 * whether or not anyone is signed in, so it works here.
 */
...
function Choices({ current }: { current: Locale }) {
